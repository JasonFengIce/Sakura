...
package app.sample.showcaseview;
...
import app.sample.showcaseview.animations.AnimationSampleActivity;
...
public class SampleActivity extends Activity implements View.OnClickListener,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.showcaseview_main);
...
//                startActivity(new Intent(this, ActionItemsSampleActivity.class));
    ...
    private static class HardcodedListAdapter extends ArrayAdapter {
        ...
        public HardcodedListAdapter(Context context) {
            super(context, R.layout.showcaseview_sample_item_next_thing);
        }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            if (convertView == null) {
                convertView = LayoutInflater.from(getContext()).inflate(R.layout.showcaseview_sample_item_next_thing, parent, false);
            }
