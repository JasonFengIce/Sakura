...
public class Utils {
    ...
    /**
     * Conditionally replace a {@link retrofit.client.Request} with an identical copy whose body is backed by a
    ...
    /**
     * Conditionally replace a {@link retrofit.client.Response} with an identical copy whose body is backed by a
     * byte[] rather than an input stream.
     */
