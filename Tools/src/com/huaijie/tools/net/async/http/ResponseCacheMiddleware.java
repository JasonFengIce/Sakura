...
import com.huaijie.tools.net.async.*;
...
import com.huaijie.tools.net.async.future.SimpleCancellable;
...
import com.huaijie.tools.net.async.http.libcore.ResponseSource;
import com.huaijie.tools.net.async.http.libcore.StrictLineReader;
import com.huaijie.tools.net.async.util.Allocator;
import com.huaijie.tools.net.async.util.Charsets;
import com.huaijie.tools.net.async.util.FileCache;
import com.huaijie.tools.net.async.util.StreamUtility;
    ...
    private static class CachedBodyEmitter extends FilteredDataEmitter {
        ...
        void spewInternal() {
            if (pending.remaining() > 0) {
                Util.emitAllData(CachedBodyEmitter.this, pending);
                if (pending.remaining() > 0)
                    return;
            }
