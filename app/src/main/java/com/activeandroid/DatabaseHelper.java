...
public final class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onOpen(SQLiteDatabase db) {
        android.util.Log.i(TAG, "onOpen ---> name: " + db.getPath() + " | version: " + db.getVersion());
        executePragmas(db);
    }

    @Override
    public void onCreate(SQLiteDatabase db) {
        android.util.Log.i(TAG, "onCreate ---> name: " + db.getPath() + " | version: " + db.getVersion());
        executePragmas(db);
        executeCreate(db);
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        android.util.Log.i(TAG, "onUpgrade ---> name: " + db.getPath() + " | oldVersion: " + oldVersion + " | newVersion: " + newVersion);
        executeDrop(db);
        executePragmas(db);
        executeCreate(db);
    ...
    private void executeDrop(SQLiteDatabase db) {
        ...
        try {
            for (TableInfo tableInfo : Cache.getTableInfos()) {
                db.execSQL(String.format("DROP TABLE IF EXISTS %s;", tableInfo.getTableName()));
            }
            db.setTransactionSuccessful();
        } finally {
            db.endTransaction();
