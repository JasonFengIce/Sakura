 ...
 */
public class IspSpinnerAdapter extends BaseAdapter {

    private Context mContext;
    private List<IspTable> mList;


    public IspSpinnerAdapter(Context context, List<IspTable> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.textView.setText(mList.get(position).isp_name);
        return convertView;
    }
