...
public class UploadFeedback implements Runnable {
    ...
    private static tv.ismar.sakura.core.UploadFeedback instance;

    private UploadFeedback() {
        messageHandler = new MessageHandler();
    }

    public static tv.ismar.sakura.core.UploadFeedback getInstance() {
        if (instance == null) {
            instance = new tv.ismar.sakura.core.UploadFeedback();
        }
        return instance;
    }
