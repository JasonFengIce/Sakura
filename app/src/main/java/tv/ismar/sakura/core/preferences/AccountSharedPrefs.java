package tv.ismar.sakura.core.preferences;
...
public class AccountSharedPrefs {
    ...
    private static tv.ismar.sakura.core.preferences.AccountSharedPrefs instance;
    ...
    public static tv.ismar.sakura.core.preferences.AccountSharedPrefs getInstance(Context context) {
        if (instance == null) {
            instance = new tv.ismar.sakura.core.preferences.AccountSharedPrefs(context);
        }
        return instance;
    }
    ...
    private void changeProvincePY(String provinceName) {
        ...
        if (provinceTable != null) {
            setSharedPrefs(tv.ismar.sakura.core.preferences.AccountSharedPrefs.PROVINCE_PY, provinceTable.pinyin);
        }
    }
}
