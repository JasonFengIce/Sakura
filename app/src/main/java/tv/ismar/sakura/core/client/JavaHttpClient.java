...
import tv.ismar.sakura.core.client.*;
...
public class JavaHttpClient {
    ...
    public void doRequest(tv.ismar.sakura.core.client.HttpMethod method, String api, HashMap<String, String> params, Callback callback) {
