...
public class IsmartvUrlClient extends Thread {
    ...
    static class MessageHandler extends Handler {
        WeakReference<tv.ismar.sakura.core.client.IsmartvUrlClient> weakReference;

        public MessageHandler(tv.ismar.sakura.core.client.IsmartvUrlClient client) {
            weakReference = new WeakReference<tv.ismar.sakura.core.client.IsmartvUrlClient>(client);
        }

        @Override
        public void handleMessage(Message msg) {
            tv.ismar.sakura.core.client.IsmartvUrlClient client = weakReference.get();
            if (client != null) {
                switch (msg.what) {
                    case SUCCESS:
